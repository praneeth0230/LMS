...
class Leave(models.Model):
    ...
    applied_to = models.CharField('Applied To', blank=False, null=False,
                                  default='saravana_kumar', choices=APPLIED_TO, max_length=500)
    created_at = models.DateTimeField(
        'Created Datetime', blank=False, auto_now_add=True)
    updated_at = models.DateTimeField(
        'Updated Datetime', blank=False, auto_now=True)
    description = models.CharField('Notes', blank=False, null=False, db_index=True,
